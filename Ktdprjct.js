    ...
    var SendButLoc = async(id, text1, desc1, gam1, but = [], options = {}) => {
      ...
      Ktdprjct.sendMessage(id, {
        ...
        quoted: mek, contextInfo: {
          mentionedJid: parseMention(text1, desc1)}}, options)
    }
        ...
        for (key in asd.presences) {
          if (asd.presences[key].lastKnownPresence == 'composing' || asd.presences[key].lastKnownPresence == 'recording') {
            ...
            if (off.checkAfkUser(key, _off)) {
              ...
              Ktdprjct.sendMessage(asd.jid, ckck.trim(), text, {
                thumbnail: fs.readFileSync('./media/logonya.jpg'), sendEphemeral: true, contextInfo: {
                  mentionedJid: Ktdprjct.parseMention(ckck)}})
            }}}}})
...
└────────────────❏`
            ...
            await Ktdprjct.sendMessage(from, ppimg, MessageType.image, {
              quoted: mek, caption: daftar, contextInfo: {
...
╰─────────────────╯`
          ...
          Ktdprjct.sendMessage(from, {
            ...
            buttons: [{
              ...
              {
                buttonId: `${prefix}ruls`, buttonText: {
                  displayText: '⚠️ Rules Bot'
                }, type: 1
              },
              {
                buttonId: `${prefix}rulesgc`, buttonText: {
                  displayText: 'Mau Masukin Bot KeGrup?'
                }, type: 1
              },
            ], headerType: 'LOCATION', locationMessage: {
              degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {
...
[ *POWERED BY ${ownername}* ]
          ...
          Ktdprjct.sendMessage(from, ktdaudio, MessageType.audio, {
            quoted: ftrol, mimetype: 'audio/mp4', ptt: true
          })
          break
        //end
        //════[ case Info ]════//
...
⚠️.OWNER TIDAK BERTANGGUNG JAWAB\nTERHADAP APA YANG DIPERINTAHKAN USER\nKEPADA BOT.`
          but = [{
            buttonId: `${prefix}rulesgc`,
            buttonText: {
              displayText: 'Rules Grupメ'
            },
            type: 1
          },
            {
...
_*Tunggu Proses Upload Media......*_`
          ...
          sendFileFromUrl(res[0].link, document, {
            mimetype: res[0].mime, filename: res[0].nama, quoted: freply
          })
          break
...
created by : Ktdproject`,
  ...
  break  */
        ...
        case 'blocklist':
          ...
          Ktdprjct.sendMessage(from, teks.trim(), extendedText, {
            quoted: mek, contextInfo: {
...
╰────`.trim()
        ...
        case 'tictactoe':
          ...
          gilir = player2
          ky_ttt.push({
            player1, player2, id, angka, gilir
          })
